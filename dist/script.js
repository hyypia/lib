...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.sibling = function () {
  let numOfItems = 0,
      counter = 0;
  const copyObj = Object.assign({}, this);
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.addAtt = function (...attributes) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.delAtt = function (...attributes) {
  for (let i = 0; i < this.length; i++) {
...
console.log(Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.more').eq(0).sibling());
